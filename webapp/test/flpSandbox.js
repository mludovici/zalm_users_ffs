		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UsersFFS",
									"targetURL": "#zalmusersffs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zalmusersffs-display": {
								"semanticObject": "zalmusersffs",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zalmusersffs",
									"url": sap.ui.require.toUrl("zalmusersffs")
								}
							}
						}
					}
